    ...
    return (
        <main>
            ...
            <section className='services p-5 '>
                ...
                <div className='services__cards-container  my-5 gap-3 row flex-md-nowrap '>
                    <div className='services__card container-fluid px-4 d-flex flex-column align-items-center col-12 col-md-4'>
                    ...
                    <div className='services__card px-4 d-flex flex-column align-items-center col-12 col-md-4'>
                        <i className="services__icon fa-solid fa-display m-4"/>
